...
const experiences = [
  {
    title: "2x Hackathon Winner, 6+ Hackathon Participant",
    period: "2024 - Present",
    description:
        ...
        >
          ...
          {!isMobile && (
            <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center">
              <motion.div
                className="w-6 h-6 rounded-full bg-gradient-to-r from-green-600 to-green-400 z-10 flex items-center justify-center"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
